...
def BDwwteDISCRETE(args):
	[l0,gam,thres,k0,W_shape,W_scale] = args
	d = te - ts
	...
	birth_rates, Kvec = birth_rates_infection(Dt, l0,gam,thres,k0,mt=death_rates)
...
head =[ "it","lik","l0","gam","thres",'k0',"W_shape","W_scale","mu0"]
...
argsA=       np.array([l0,gam ,thres ,k0   ,W_shape,W_scale])
update_freq =np.array([1.,0   ,0     ,1    ,1      ,1      ])   
